    ...
    <div className="flex min-h-screen flex-col bg-brand-glow">
      ...
      <header className="sticky top-0 z-50 border-b border-white/60 bg-white/80 backdrop-blur-xl">
        <PageContainer className="flex h-20 items-center justify-between gap-6">
          ...
          <nav className="hidden items-center gap-2 md:flex">
            <Link
              to="/"
              className="rounded-full px-4 py-2 text-sm font-medium text-ink-600 transition-all duration-200 hover:bg-primary-50 hover:text-primary-700 hover:-translate-y-0.5 active:scale-95 [&.active]:bg-primary-700 [&.active]:text-primary-50"
            >
              Trang chủ
            </Link>
            <Link
      ...
      <footer className="border-t border-white/70 bg-white/70 py-10 backdrop-blur-xl">
        <PageContainer className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <BrandLogo className="h-12 sm:h-14 w-auto object-contain" />
